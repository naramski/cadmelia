...
public class CADmeliaProjectTemplatePanelVisual extends JPanel implements DocumentListener {

    public static final String PROP_PROJECT_NAME = "projectName";

    private CADmeliaProjectTemplateWizardPanel panel;

    public CADmeliaProjectTemplatePanelVisual(CADmeliaProjectTemplateWizardPanel panel) {
        initComponents();
        this.panel = panel;
    ...
    void read(WizardDescriptor settings) {
        ...
        if (projectName == null) {
            projectName = "CADmeliaProjectTemplate";
        }

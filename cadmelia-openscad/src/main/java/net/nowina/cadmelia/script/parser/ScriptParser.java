...
public class ScriptParser implements ScriptParserConstants {
  ...
  final public Iteration For() throws ParseException {String variable;
    Expression start;
    Expression end;
    Iteration it;
    Command c;
...
{if ("" != null) return new Vector(x,y,z);}
  ...
  final public Expression Vector() throws ParseException {Expression x,y,z = null;
    ...
    jj_consume_token(RB);
{if ("" != null) return Expression.element(x,y,z);}
    throw new Error("Missing return statement in function");
  }

  final public List VectorList() throws ParseException {List l = null;
    Expression v = null;
    jj_consume_token(LB);
    v = Vector();
...
{if ("" != null) return m;}
  ...
  final public Instruction Statement() throws ParseException {Module module;
    Command op;
    Define def;
    Iteration it;
    if (jj_2_25(4)) {
...
{if ("" != null) return command;}
  ...
  final public Expression Element() throws ParseException {Double value;
    ...
    if (jj_2_31(4)) {
      value = Number();
{if ("" != null) return Expression.element(value);}
    } else if (jj_2_32(4)) {
      name = Name();
{if ("" != null) return Expression.element(name);}
    } else if (jj_2_33(4)) {
      list = VectorList();
{if ("" != null) return Expression.element(list);}
    } else if (jj_2_34(4)) {
      function = Function();
{if ("" != null) return Expression.element(function);}
    } else if (jj_2_35(4)) {
      bool = Boolean();
{if ("" != null) return Expression.element(bool);}
    } else if (jj_2_36(4)) {
      text = String();
{if ("" != null) return Expression.elementText(text);}
    } else if (jj_2_37(4)) {
      jj_consume_token(LP);
      expression = Expression();
      jj_consume_token(RP);

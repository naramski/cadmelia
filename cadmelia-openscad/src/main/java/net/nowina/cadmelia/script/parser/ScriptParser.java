...
{if ("" != null) return expression;}
      ...
      function = Function();
{if ("" != null) return Expression.elementFunction(function);}
    } else if (jj_2_59(4)) {
      name = Name();
...
{if ("" != null) return expression;}
  ...
  final public Expression vectorElement() throws ParseException {String variableName;
    ...
    index = Expression();
    jj_consume_token(RB);
{if ("" != null) return Expression.vectorElement(variableName, index);}
    throw new Error("Missing return statement in function");
  }
...
{if ("" != null) return exp;}
  ...
  final public Expression Expression() throws ParseException {Expression exp;
    ...
    if (jj_2_81(4)) {
      ...
      jj_consume_token(COLON);
      elseExpr = Term();
{if ("" != null) return Expression.inlineIf(exp, thenExpr, elseExpr);}
    } else {
      ;
    }
{if ("" != null) return exp;}

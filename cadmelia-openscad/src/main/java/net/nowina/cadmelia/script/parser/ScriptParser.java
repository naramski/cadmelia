...
{if ("" != null) return ifCommand;}
  ...
  final public Iteration iteration() throws ParseException {String variable;
    Expression iterableDef;
    Iteration iteration;
    variable = Name();
    jj_consume_token(EQ);
    iterableDef = Element();
{if ("" != null) return new Iteration(variable, iterableDef);}
    throw new Error("Missing return statement in function");
  }

  final public ForCommand For() throws ParseException {ForCommand it;
    Iteration iteration;
    Instruction instruction;
    if (jj_2_7(6)) {
...
{if ("" != null) return list;}
  ...
  final public Expression indexVectorElement(Expression list) throws ParseException {Expression index;
    Expression expr;
expr = list;
    label_14:
    while (true) {
...
{if ("" != null) return exp;}
  ...
  final public Expression ExpressionAnd2Or2() throws ParseException {Expression exp;
    Expression exp2;
...
{if ("" != null) return exp;}
  ...
  final public Expression letOrExpression() throws ParseException {String variableName;
    Expression exp;
    if (jj_2_91(6)) {
      jj_consume_token(LET);
      jj_consume_token(LP);
...
{if ("" != null) return exp;}
  ...
  final public Expression inlineIfExpression() throws ParseException {Expression exp;

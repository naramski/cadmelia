...
public class SolidMesh {
    ...
    SolidMesh(Solid solid) {
        ...
        ConvertToJavaFXVisitor converter = new ConvertToJavaFXVisitor(mesh);
    ...
    private static class ConvertToJavaFXVisitor implements MeshVisitor {
        ...
        public ConvertToJavaFXVisitor(TriangleMesh mesh) {
            this.mesh = mesh;
            counter = 0;
